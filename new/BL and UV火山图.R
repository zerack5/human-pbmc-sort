setwd("D:\\data anlysis\\pf")

heatdata<-read.csv("D:/data anlysis/pf/myy-BL-UV-CL/BL_UV_res.csv", header = TRUE)
colnames(heatdata)
...
ggsave("BL and UV.tiff",device = "tiff",scale = 1.5,width = NA,height = NA,dpi = 300,path = "D:\\data anlysis\\pf\\figure")